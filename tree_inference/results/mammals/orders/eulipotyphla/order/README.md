Phylogenetic reconstruction of the order Eulipotyphla
--------------

This folder structure contains the results of the phylogenetic inference of the order Eulipotyphla
