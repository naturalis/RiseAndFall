Phylogenetic reconstruction of the order Didelphimorphia
--------------

This folder structure contains the results of the phylogenetic inference of the order Didelphimorphia
