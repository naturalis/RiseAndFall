Phylogenetic reconstruction of the order Dasyuromorphia
--------------

This folder structure contains the results of the phylogenetic inference of the order Dasyuromorphia
