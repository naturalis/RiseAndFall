This directory contains phylogenetic trees of random taxonomic groups of Mammalian clade. These trees are not used in the 
reconstruction of the complete mammalian phylogeny.
--------------
