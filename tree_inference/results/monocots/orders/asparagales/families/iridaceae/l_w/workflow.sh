...
smrt taxize -r Larentia,Libertia,Mastigostyla,Melasphaerula,Micranthus,Moraea,Nemastylis,Neomarica,Nivenia,Olsynium,Orthrosanthus,Patersonia,Phalocallis,Pillansia,Pseudiris,Pseudotrimezia,Radinosiphon,Rigidella,Romulea,Savannosiphon,Sessilanthera,Sisyrinchium,Solenomelus,Sparaxis,Syringodea,Thereianthus,Tigridia,Trimezia,Tritonia,Tritoniopsis,Watsonia,Witsenia,Elaeis -b
